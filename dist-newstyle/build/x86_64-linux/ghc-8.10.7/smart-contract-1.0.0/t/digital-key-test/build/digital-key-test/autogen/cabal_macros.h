...
/* package smart-contract-1.0.0 */
#ifndef VERSION_smart_contract
#define VERSION_smart_contract "1.0.0"
#endif /* VERSION_smart_contract */
#ifndef MIN_VERSION_smart_contract
#define MIN_VERSION_smart_contract(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_smart_contract */
...
/* package plutus-ledger-1.2.0.0 */
#ifndef VERSION_plutus_ledger
#define VERSION_plutus_ledger "1.2.0.0"
...
#define CURRENT_COMPONENT_ID "smart-contract-1.0.0-inplace-digital-key-test"
